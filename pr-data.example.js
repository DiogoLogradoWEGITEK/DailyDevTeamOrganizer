if (!window.PR_DATA_EXAMPLE) {
  window.PR_DATA_EXAMPLE = {
    ...
    Alice: [
      ...
      { title: "Update API rate limiting docs", number: 135, repo: "backend-api", branch: "docs/rate-limiting", baseBranch: "main", body: "update rate limit docs · fix broken link · add throttle examples" }
    ],
    Bob: [
    ...
    Carol: [
      ...
      { title: "Redesign dashboard layout", number: 211, repo: "frontend", branch: "feat/dashboard-redesign", baseBranch: "develop", body: "update sidebar layout · responsive grid · dark mode toggle" }
    ]
  };
}
